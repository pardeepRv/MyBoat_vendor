...
const WelComeNote = () => {
  return (
    <View style={styles.WelComeNote}>
      <Text style={[styles.myboat,{textAlign:'left'}]}>{I18n.translate('myBoat')}</Text>
        ...
        <KeyboardAwareScrollView>
          <View style={styles.SEC2}>
            ...
            animationOutTiming={500}>
              <View   style={{height:150,width:150,alignSelf:'center',backgroundColor:'white',justifyContent:'center',backgroundColor:"#000",opacity:0.8,borderRadius:10}}>
            ...
            <View style={{marginVertical:5,marginBottom:20}}>
              ...
              <View style={{borderBottomWidth:1,borderColor:'#fff',marginVertical:10}}>
              <TextInput
              ...
              <View style={{flexDirection: 'row', alignItems: 'center',borderBottomWidth:1,borderColor:'#fff',justifyContent:'space-between'}}>
                <TextInput
