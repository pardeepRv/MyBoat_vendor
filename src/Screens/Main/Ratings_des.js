...
const DetailsRatings = ({ route }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.white }}>
      <Header imgBack={true} backBtn={true} />
        ...
        <ScrollView style={{ marginTop: 20, paddingHorizontal: 20 }}>
          ...
          >
            ...
            <AirbnbRating
              ...
              size={14}
              count={5}
              defaultRating={route.params.item.total_rating}
              isDisabled
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={{ fontFamily: FontFamily.semi_bold, fontSize: 14 }}>
            ...
            <View style={{ marginVertical: 10 }}>
              ...
              >
                <Text
                  style={{ fontSize: 13, fontFamily: FontFamily.semi_bold }}
                >
                  {I18n.translate("time")}
                </Text>
                <AirbnbRating
                  ...
                  size={15}
                  count={5}
                  defaultRating={route.params.item.time_rating}
                  isDisabled
                  selectedColor="#FFCC39"
                  starContainerStyle={{
                    elevation: 5,
              ...
              >
                ...
                <AirbnbRating
                  ...
                  size={15}
                  count={5}
                  defaultRating={route.params.item.captain_rating}
                  isDisabled
                  selectedColor="#FFCC39"
                  starContainerStyle={{
                    elevation: 5,
              ...
              >
                ...
                <AirbnbRating
                  ...
                  size={15}
                  count={5}
                  defaultRating={route.params.item.food_rating}
                  isDisabled
                  selectedColor="#FFCC39"
                  starContainerStyle={{
                    elevation: 5,
              ...
              >
                ...
                <AirbnbRating
                  ...
                  size={15}
                  count={5}
                  defaultRating={route.params.item.clean_rating}
                  isDisabled
                  selectedColor="#FFCC39"
                  starContainerStyle={{
                    elevation: 5,
              ...
              >
                ...
                <AirbnbRating
                  ...
                  size={15}
                  count={5}
                  defaultRating={route.params.item.hospitality_rating}
                  isDisabled
                  selectedColor="#FFCC39"
                  starContainerStyle={{
                    elevation: 5,
              ...
              >
                ...
                <AirbnbRating
                  ...
                  size={15}
                  count={5}
                  defaultRating={route.params.item.equip_rating}
                  isDisabled
                  selectedColor="#FFCC39"
                  starContainerStyle={{
                    elevation: 5,
              ...
              >
                ...
                <AirbnbRating
                  ...
                  count={5}
                  isDisabled
                  defaultRating={route.params.item.entertain_rating}
                  selectedColor="#FFCC39"
                  starContainerStyle={{
                    elevation: 5,
                    // alignSelf:"flex-start"
