...
import {Icon, Input, Card, AirbnbRating, Overlay} from 'react-native-elements';
    ...
    if (
      ...
      this.state.item?.destination_arr.map((item, index) => {
        if (index === this.state.item?.destination_arr.length - 1) {
          destinations += this.props.language_id == 0? item?.destination[0]:item?.destination[1];
  ...
  getPreferencesDetails() {
    ...
    let equipmentDetails =
      (this.state.item?.addon_arr !== 'NA' &&
        this.state.item?.addon_arr?.length &&
        this.state.item?.addon_arr.filter(
          item => item.addon_name[0] === 'Equipment ',
        )) ||
      [];
    this.setState({
            ...
            <View>
              <View style={styles.adressbox}>
                <View
                  ...
                  <View style={{marginStart: 15}}>
                    ...
                    />
                    <Text style={{fontSize: 15,fontFamily:FontFamily.semi_bold,textAlign:'left'}}>
                      {this.props.language_id == 0? (this.state.item?.captain_name[0] &&
                        this.state.item?.captain_name[0]):(this.state.item?.captain_name[1] &&
              ...
              <View
                ...
                <View style={{alignItems: 'center', flex: 1}}>
                  ...
                  <Text
                    style={{fontFamily: FontFamily.default, marginVertical: 3}}>
                    {this.props.language_id == 0? this.state.item?.trip_type_name[0]:this.state.item?.trip_type_name[1]}
                  </Text>
                </View>
                <View style={{alignItems: 'center', flex: 1}}>
                  <View
                  ...
                  <Text
                    style={{fontFamily: FontFamily.default, marginVertical: 3}}>
                    {this.props.language_id == 0? this.state.item?.city_name[0]:this.state.item?.city_name[1]}
                  </Text>
                </View>
              </View>
              <View
              ...
              <View
                ...
                <Text style={[{fontFamily: FontFamily.default},{textAlign:'left'}]}>
                  {this.props.language_id == 0? this.state.item?.discription_arr[0]: this.state.item?.discription_arr[1]}
                </Text>
                <View
                  style={{
                    height: 0,
                ...
                <View style={{flexDirection: 'row', width: '100%'}}>
                  ...
                  <Text style={styles.adDetailsTextHeader1}>
                    {this.state.item?.boat_type === 1 ? I18n.translate('private') : I18n.translate('public')}
                  </Text>
                </View>
                <View style={{flexDirection: 'row', width: '100%'}}>
                  <Text style={styles.adDetailsTextHeader}>{I18n.translate('trip_type')}</Text>
                  <Text style={styles.adDetailsTextHeader1}>
                ...
                <View style={{flexDirection: 'row', width: '100%'}}>
                  ...
                  <Text style={[styles.adDetailsTextHeader1,{textAlign:'left'}]}>
                ...
                <View style={{flexDirection: 'row', width: '100%'}}>
                  ...
                  <Text style={styles.adDetailsTextHeader1}>
                    {this.state.item?.extra_price }{`${I18n.translate('kwd')}`}
                  </Text>
                </View>
                <View style={{flexDirection: 'row', width: '100%'}}>
                  <Text style={styles.adDetailsTextHeader}>{I18n.translate('trip_time')}</Text>
                  <Text style={[styles.adDetailsTextHeader1,{textAlign:'left'}]}>
                ...
                <View style={{flexDirection: 'row', width: '100%'}}>
                  ...
                  <Text style={styles.adDetailsTextHeader1}>
                    {`${this.state.item?.minimum_hours}` +  `${I18n.translate('hours')}` }
                  </Text>
                </View>
                <View style={{flexDirection: 'row', width: '100%'}}>
                  <Text style={styles.adDetailsTextHeader}>
                ...
                <View style={{flexDirection: 'row', width: '100%'}}>
                  ...
                  <Text style={styles.adDetailsTextHeader1}>
                    {this.state.equipmentsCount ?  I18n.translate('available') :  I18n.translate('not_available')}
                  </Text>
                </View>
                <View style={{flexDirection: 'row', width: '100%'}}>
                  <Text style={styles.adDetailsTextHeader}>
                  ...
                  <Text style={styles.adDetailsTextHeader1}>
                    {!this.state.entertainmentCount
                      ? I18n.translate('available') :  I18n.translate('not_available')}
                  </Text>
                </View>
                <View style={{flexDirection: 'row', width: '100%'}}>
                  <Text style={styles.adDetailsTextHeader}>{I18n.translate('food')}</Text>
                  <Text style={styles.adDetailsTextHeader1}>
                    {this.state.foodCount ? I18n.translate('available') :  I18n.translate('not_available')}
                  </Text>
                </View>
              </View>
              <View
                  ...
                  <View
                   ...
                   { I18n.translate('rental_price')}
                    ...
                    <Text
                      ...
                      {`${this.state.destinationPrices}`+`${I18n.translate('kwd')}`}
                    </Text>
                  </View>
                </View>
              </View>
