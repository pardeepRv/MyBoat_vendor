...
class FirebaseProvider {
  ...
  getAllUsers = async () => {
    ...
    queryUsers.on('child_changed', function (data) {
      ...
      console.log('FF--', FirebaseUserJson);
      ...
      console.log('RR--', FirebaseUserJson);
  ...
  getMyInboxAllData = async () => {
    ...
    if (userdata != null) {
	  ...
	  console.log("GG--",FirebaseUserJson)
      //--------------------------------- update code --------------
      var queryUpdate = firebase.database().ref('users/' + id + '/myInbox/');
  ...
  firebaseUserCreateUpdatePlayerId = async () => {
    ...
    console.log(
      'firebaseUserCreateUpdatePlayerId update_firebase_check',
      update_firebase_check,
    );
    ...
    queryAllUser.once('value', data => {
      ...
      var find_inbox_index = allUserArr.findIndex(
        x => x.player_id == player_id_me,
      );
      console.log(
        'find_inbox_index firebaseUserCreateUpdatePlayerId',
        find_inbox_index,
      );
